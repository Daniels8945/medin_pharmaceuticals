...
return (
        <div className="relative h-[400px] bg-white border-1 border-neutral-200 shadow-md rounded-lg flex flex-col items-center">
          ...
          <div className=" flex flex-col w-full p-4 gap-2">
            ...
            <Link to={"/exploreproducts"} className="break-all cursor-pointer text-black mt-4 text-md truncate font-bold font-raleway flex items-center gap-4 text-zinc-600">View<div className="truncate w-fit">{name}</div>details<IoArrowForward className="text-green-500 text-lg" /></Link>
          </div>
        </div>
  );
}
