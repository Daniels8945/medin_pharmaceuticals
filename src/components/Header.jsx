...
function Header() {
  ...
  const dialog = (
    <>
      <dialog className="absolute lg:hidden fixed- animate-in fade-in slide-in-from-top-5 flex flex-col gap-3 top-0 w-full h-screen py-6 px-4  overflow-hidden scroll-none">
