    ...
    return(
        <div className="flex flex-col gap-8">
           <div  className="gap-2 z-10 sticky top-0 px-4 xl:px-12 shadow-md flex flex-col xl:flex-row xl:items-center-safe justify-center xl:justify-between bg-white w-full h-[100px]">
                ...
                <Link to="/addproducts" className="flex items-center text-[20px] font-semibold font-raleway gap-4 pt-4 cursor-pointer hover:underline"> Add Products <FaExternalLinkAlt className="text-green-500" /> </Link>
           </div>
